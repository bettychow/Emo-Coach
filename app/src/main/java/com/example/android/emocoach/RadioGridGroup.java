...
public class RadioGridGroup extends TableLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        System.out.println("Radio grid group onclick");
        ...
        System.out.println("hello i am the checked id");
        System.out.println(checkedId);

        RadioButton checkedRadioButton = (RadioButton) rGroup.findViewById(checkedId);

        System.out.println(checkedRadioButton);
...
//                emotions.setCompoundDrawablesWithIntrinsicBounds(null, null, radioImgValue, null);
    ...
    public void check(@IdRes int id) {
        ...
        System.out.println("setting the checked id");
        setCheckedId(id);
    }
